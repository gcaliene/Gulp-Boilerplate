...
var Modal = function () {
  ...
  _createClass(Modal, [{
    ...
    value: function events() {
      ...
      //clicking the x close modal header__button
      this.closeModalButton.click(this.closeModal.bind(this));
      //escape key on the keyboard, now pushing any keywords
      (0, _jquery2.default)(document).keyup(this.keyPressHandler.bind(this)); //keyup is jquery fire when user lets go of key
    }
  }, {
    key: "keyPressHandler",
